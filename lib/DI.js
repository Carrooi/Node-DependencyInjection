(function() {
  ...
  DI = (function() {
    ...
    DI.prototype.addService = function(name, service, args) {
      var arg, factory, i, instantiate, match, originalService, _i, _len;
      if (args == null) {
        args = [];
      }
      ...
      this.services[name] = (new Service(this, name, service, args)).setInstantiate(instantiate).setFactory(factory);
